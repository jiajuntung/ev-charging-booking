    ...
    <div class="w-full max-w-md rounded-[32px] bg-white shadow-[0_18px_40px_rgba(0,0,0,0.10)] overflow-hidden border border-gray-100">
        ...
        <div class="px-8 py-10">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-black text-[#664c35] tracking-tight">Reset Password</h1>
                <p class="text-sm text-gray-500 mt-2 leading-relaxed">Enter your new password below to regain access.</p>
            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                ...
                <div x-data="{ show: false }">
                    <label for="password" class="block text-sm font-bold text-[#664c35] mb-1.5">New Password</label>
